...
//        TogetherAdKs.init(context = this, adProviderType = AdProviderType.KS.type, ksAdAppId = "90009")
        ...
        TogetherAdCsj.idMapCsj = mutableMapOf(
            TogetherAdAlias.AD_SPLASH to "889323577",
            TogetherAdAlias.AD_REWARD to "958004977",
            TogetherAdAlias.AD_NATIVE_EXPRESS_RECYCLERVIEW to "958005214"
        )

        TogetherAdGdt.idMapGDT = mutableMapOf(
            TogetherAdAlias.AD_SPLASH to "4110115718280722",
            TogetherAdAlias.AD_REWARD to "6100812748092021",
            TogetherAdAlias.AD_NATIVE_EXPRESS_RECYCLERVIEW to "4100808718431227"
        )

        TogetherAdKs.idMapKs = mutableMapOf(
            TogetherAdAlias.AD_SPLASH to 17876000003,
            TogetherAdAlias.AD_REWARD to 17876000001,
            TogetherAdAlias.AD_NATIVE_EXPRESS_RECYCLERVIEW to 17876000004
        )

        TogetherAdBaidu.idMapBaidu = mutableMapOf(
            TogetherAdAlias.AD_SPLASH to "16015168",
            TogetherAdAlias.AD_REWARD to "16015380",
            TogetherAdAlias.AD_NATIVE_EXPRESS_RECYCLERVIEW to "16015380"
        )
